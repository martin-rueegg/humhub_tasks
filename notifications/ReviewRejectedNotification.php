 ...
 * @since 0.5
 */
class ReviewRejectedNotification extends BaseNotification
{
    /**
     * @inheritdoc
     */
    ...
    {
        return Yii::t('TasksModule.base', '{userName} has rejected task {task} in space {spaceName} as incomplete.', [
